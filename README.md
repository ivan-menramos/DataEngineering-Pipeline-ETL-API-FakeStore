...
4. **Infraestructura:** Todo el entorno (Script de Python y el motor de Base de Datos) está orquestado mediante **Docker Compose**, lo que garantiza que el pipeline sea reproducible en cualquier sistema sin conflictos de dependencias.
